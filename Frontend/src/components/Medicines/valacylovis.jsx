...
const CarouselTestimonials = () => {
  const testimonials = [
    { name: "Mark Thompson", role: "Patient with HSV", text: "Valacyclovir has dramatically reduced my outbreaks. I feel more in control of my condition now." },
    { name: "Dr. Lisa Reynolds", role: "Dermatologist", text: "Highly effective for herpes suppression with excellent safety profile and convenient dosing." },
    { name: "Jennifer Park", role: "Patient, 32", text: "The daily suppression therapy has changed my life. I haven't had an outbreak in over a year." },
    { name: "Robert Chang", role: "Pharmacist", text: "Patients report high satisfaction with outbreak prevention and minimal side effects." }
  ];
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    Effective antiviral medication for herpes outbreak prevention and treatment.
                  </Typography>
                </motion.div>
              </Grid>
          ...
          >
            <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
              ...
              <motion.div variants={fadeInUp}>
                ...
                >
                  Proven antiviral therapy for suppressing outbreaks and reducing transmission risk
                </Typography>
              </motion.div>
            </Box>
          </motion.div>
              ...
              {[
                {
                  icon: <Shield size={28} />,
                  title: 'Outbreak Prevention',
                  description: 'Daily suppressive therapy can reduce outbreak frequency by 70-80%.',
                  color: colors.darkBlue,
                  delay: 0.1,
                ...
                },
                {
                  ...
                  title: 'Reduced Transmission',
                  description: 'Lowers risk of passing the virus to partners by approximately 50%.',
                ...
                {
                  icon: <Zap size={28} />,
                  title: 'Fast Outbreak Treatment',
                  description: 'Shortens healing time when taken at first sign of symptoms.',
                  color: '#0066CC',
                  delay: 0.3,
                ...
                },
                {
                  ...
                  description: 'Reduces pain, itching, and duration of herpes outbreaks.',
                  color: '#4CAF50',
                  delay: 0.4,
          ...
          <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                ...
                <CardContent sx={{ textAlign: "center", py: 4 }}>
                  ...
                  >
                    Herpes Outbreak Prevention & Treatment
                  </Typography>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  Valacyclovir is converted to acyclovir in the body, which inhibits viral DNA replication, 
                  preventing the herpes virus from multiplying. This reduces outbreak frequency, severity, 
                  and duration while also lowering transmission risk to partners.
                </Typography>
                ...
                >
                  Available for both episodic treatment (taken at first sign of outbreak) and daily 
                  suppression therapy (taken continuously to prevent outbreaks), providing flexible 
                  treatment options based on individual needs and outbreak patterns.
                </Typography>
              </Box>
            </motion.div>
          </Container>
              ...
              {[
                {
                  ...
                  text: "Prevents herpes virus from replicating and spreading to new cells.",
                },
                {
                  icon: <Shield size={22} />,
                  title: "Outbreak Prevention",
                  text: "Daily therapy suppresses viral activity to prevent outbreaks.",
                },
                {
                  icon: <Zap size={22} />,
                  title: "Fast Treatment",
                  text: "Episodic treatment shortens healing time when taken early.",
                },
                {
                  icon: <ShieldCheck size={22} />,
                  title: "Transmission Reduction",
                  text: "Lowers viral shedding, reducing risk of passing to partners.",
                },
              ].map((item, i) => (
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: "center", mb: 10 }}>
                ...
                >
                  Real Experiences with Valacyclovir
                </Typography>
              </Box>
            </motion.div>
        ...
        >
          ...
          <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                Take Control of Herpes Outbreaks
              </Typography>
              ...
              >
                Reduce outbreak frequency, severity, and transmission risk with effective 
                antiviral therapy. Consult with a healthcare provider today.
              </Typography>
              ...
              >
                *Valacyclovir is a prescription antiviral medication for herpes simplex virus (HSV) 
                infections. Consult a healthcare provider to determine if it's appropriate for your 
                condition. Use only as directed by your physician.
              </Typography>
            </motion.div>
          </Container>
        </Box>
