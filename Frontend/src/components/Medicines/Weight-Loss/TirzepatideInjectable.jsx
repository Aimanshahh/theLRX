...
// Price configuration for Terzepatide
const PRICE = {
  amount: 289.00,
  currency: 'USD',
  display: '$289.00',
...
const injectionBenefits = [
  { icon: TrendingUp, text: 'Dual Action', color: '#10B981' },
    ...
    <Box sx={{ mt: 8 }}> {/* ADDED: This wrapper pushes content below navbar */}
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    Advanced GLP-1 & GIP dual agonist for superior weight management and glycemic control
                  </Typography>
                </motion.div>
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    Weekly Injection • Clinically Proven • Superior Efficacy
                  </Typography>
                </motion.div>
              </Grid>

              {/* Icons Section - Benefits - Updated for Terzepatide */}
              <Grid item xs={12}>
                <motion.div variants={fadeInUp}>
                  <Grid container spacing={2} justifyContent="flex-start">
                    {[
                      ...
                      },
                      {
                        ...
                        title: 'Enhanced Efficacy',
                        delay: 0.2
                      },
                      {
                        icon: <Scale size={isMobile ? 22 : 26} color={colors.white} />,
              ...
              <Grid item xs={12}>
                ...
                {/* Key Features - Updated for Terzepatide */}
                <motion.div
                  variants={fadeInUp}
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            ...
            >
              ...
              <CardContent sx={{ textAlign: "center", py: 4 }}>
                ...
                >
                  *Weekly Injection • Dual Agonist • Prescription included
                </Typography>
          ...
          {/* Description Section - Updated for Terzepatide */}
          <motion.div
      ...
      {/* New How It Works Section - Updated for Terzepatide */}
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
                  ...
                  {/* Mechanism Points - Updated for Terzepatide */}
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                    {[
                      {
                        icon: <Target size={24} color={colors.darkBlue} />,
                        title: "Dual Receptor Activation",
                        description: "Simultaneously activates GLP-1 and GIP receptors for enhanced efficacy"
                      },
                      {
                        icon: <Zap size={24} color={colors.darkBlue} />,
                        title: "Enhanced Insulin Sensitivity",
                        description: "Improves glucose metabolism through multiple pathways"
                      },
                      {
                        icon: <CheckCircle size={24} color={colors.darkBlue} />,
                        title: "Superior Weight Loss",
                        description: "Clinical trials show greater weight reduction than single agonists"
                      }
                    ].map((point, index) => (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  {/* Main Description - Updated for Terzepatide */}
                  <Box
                    sx={{
                      p: 4,
                      borderRadius: "20px",
                  ...
                  {/* Usage Instructions - Updated for Terzepatide */}
                  <Box
                    sx={{
                      p: 3,
                      backgroundColor: colors.white,
                  ...
                  >
                    ...
                    >
                      Administered once weekly via subcutaneous injection. Significant weight loss 
                      typically observed within 8-12 weeks, with maximum benefits achieved after 
                      24-36 weeks of consistent treatment.
                    </Typography>
                  </Box>
                </Box>
              </motion.div>
      ...
      {/* Testimonials Section - Updated for Terzepatide */}
      <TestimonialCarousel />
          ...
          >
            <Box sx={{ 
              ...
              >
                ...
                >
                  Start Your Dual Agonist Journey
                </Typography>
              </motion.div>
              ...
              <Grid container spacing={3} justifyContent="center" sx={{ mt: 4 }}>
                {[
                  { text: "Superior Clinical Results" },
                  { text: "Free Medical Consultation" },
                  { text: "Weekly Convenience" },
                  { text: "Dual Mechanism Benefits" },
                ].map((feature, index) => (
...
// Testimonial Component - Updated for Terzepatide
const TestimonialCarousel = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content: 'After trying other GLP-1 medications, Terzepatide was the game-changer. Superior weight loss and my energy levels are fantastic.',
      result: 'A1C: 5.6%',
    ...
    },
    {
      ...
      content: 'The weekly injection is so convenient. I lost 40 pounds and feel better than I have in years. Highly recommend this treatment!',
      result: 'Weight: -40 lbs',
      ...
      <Container maxWidth="lg">
        ...
        >
          <Box textAlign="center" mb={{ xs: 6, md: 8 }}>
            ...
            >
              Real patients achieving superior weight loss with dual agonist therapy
            </Typography>
          </Box>
