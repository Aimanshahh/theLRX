...
// Color scheme - Same blue theme as Retatrutide
const colors = {
  black: '#000000',
  white: '#FFFFFF',
  darkBlue: '#00359E', // Same as Retatrutide
  lightBlue: '#0066CC', // Same as Retatrutide
  lightGrey: '#E5E7EB',
  darkGrey: '#4B5563',
  success: '#10B981'
};

// Price configuration for Oral Tirzepatide
const PRICE = {
  amount: 379.00,
  currency: 'USD',
  display: '$379.00',
...
const pillBenefits = [
  ...
  { icon: Heart, text: 'Blood Sugar Control', color: '#EF4444' },
  { icon: Target, text: 'GLP-1 & GIP Agonist', color: colors.darkBlue },
  { icon: Activity, text: 'Metabolic Boost', color: '#F59E0B' },
  { icon: Droplets, text: 'Appetite Control', color: colors.lightBlue },
  { icon: Shield, text: 'Non-Invasive', color: colors.darkBlue }
];
        ...
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            ...
            >
              ...
              <Box
                component="img"
                src={oralTirzepatideImg}
                alt="Oral Tirzepatide RDT"
                sx={{
                  width: "100%",
                  height: 360,
                  objectFit: "contain",
              ...
              <CardContent sx={{ textAlign: "center", py: 4 }}>
                ...
                >
                  Oral Weight Management Solution
                </Typography>
                ...
                >
                  *Rapid Dissolve Tablet • No injection required • Prescription included
                </Typography>
...
>
  ...
  applications under the guidance of a licensed healthcare provider.
              ...
              >
                Clinical studies demonstrate significant weight loss and improved glycemic control, 
                with the added convenience of oral administration for better treatment adherence.
              </Typography>
            </Box>
          </motion.div>
        </Container>
        ...
        <Container sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            <Box sx={{ 
              ...
              >
                Take the first step towards effective weight control without injections. 
                Our convenient oral RDT format offers the benefits of Tirzepatide in an 
                easy-to-take tablet. Start your personalized treatment today.
              </Typography>
    ...
    >
      Or explore our injection-free options
              ...
              <Grid container spacing={3} justifyContent="center" sx={{ mt: 4 }}>
                {[
                  { text: "No Injections Required" },
                  { text: "Free Medical Consultation" },
                  { text: "Discreet Home Delivery" },
                  { text: "Ongoing Physician Support" },
                ].map((feature, index) => (
  ...
  const testimonials = [
    {
      ...
      content: 'The oral RDT is life-changing! No more injections, and I lost 18 pounds in 3 months. So convenient and effective.',
      result: 'Lost 18 lbs',
    ...
    },
    {
      ...
      content: 'Finally, an effective weight loss medication without injections. My A1C improved and I feel more energetic.',
      result: 'A1C: 6.2%',
    ...
    },
    {
      ...
      location: 'Chicago, IL',
      rating: 5,
      condition: 'PCOS + Weight',
      content: 'As someone who hates needles, this oral option is perfect. The rapid-dissolve tablet works quickly and effectively.',
      result: 'Weight: -22 lbs',
      ...
      <Container maxWidth="lg">
        ...
        >
          <Box textAlign="center" mb={{ xs: 6, md: 8 }}>
            ...
            >
              Real patients achieving weight loss with convenient oral treatment
            </Typography>
          </Box>
...
export default OralTirzepatidePage;