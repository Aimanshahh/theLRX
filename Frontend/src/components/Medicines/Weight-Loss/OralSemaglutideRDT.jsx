...
// Price configuration for Oral Semaglutide
const PRICE = {
  amount: 249.00,
  currency: 'USD',
  display: '$249.00',
...
// Rimo URL
const RIMO_URL = 'https://try.thelrx.com/intake/wm-ltaaov';

// Benefits for the "How It Works" section - Updated for Semaglutide
const pillBenefits = [
  ...
  { icon: Shield, text: 'Oral Convenience', color: colors.darkBlue }
];

const OralSemaglutidePage = () => {
  ...
  return (
    <Box sx={{ mt: 8 }}> {/* ADDED: Margin-top to push content below navbar */}
      ...
      >
        ...
        >
          ...
          {/* Gradient Overlay - Same as Retatrutide */}
          <Box
            sx={{
              position: 'absolute',
              top: 0,
    ...
    mt: -1
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    Convenient oral formulation for effective weight management and glycemic control
                  </Typography>
                </motion.div>
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    Oral Rapid Dissolve Tablet • No injections needed
                  </Typography>
                </motion.div>
              </Grid>
              ...
              <Grid item xs={12}>
                <motion.div variants={fadeInUp}>
                  <Grid container spacing={2} justifyContent="flex-start">
                    {[
                      {
                        icon: <Pill size={isMobile ? 22 : 26} color={colors.white} />,
                        title: 'Oral Convenience',
                        delay: 0.1
                      },
                      {
                        icon: <Thermometer size={isMobile ? 22 : 26} color={colors.white} />,
                        title: 'Dual Agonist',
                        delay: 0.2
                      },
                      {
                        icon: <Battery size={isMobile ? 22 : 26} color={colors.white} />,
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  >
                    Start Oral Treatment Consultation
                  </Button>
                </motion.div>
        ...
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            ...
            >
              ...
              <Box
                component="img"
                src={oralSemaglutideImg}
                alt="Oral Semaglutide RDT"
                sx={{
                  width: "100%",
                  height: 360,
                  objectFit: "contain",
              ...
              <CardContent sx={{ textAlign: "center", py: 4 }}>
                ...
                >
                  *Rapid Dissolve Tablet • Clinically Proven • Prescription included
                </Typography>
          ...
          {/* Description Section - Updated for Semaglutide */}
          <motion.div
...
>
  ...
  use should occur only with appropriate medical oversight.
      ...
      {/* New How It Works Section - Updated for Semaglutide */}
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
                  ...
                  >
                    Oral Semaglutide works by activating GLP-1 receptors throughout the body, 
                    influencing multiple pathways that control appetite, metabolism, and 
                    cardiovascular function.
                  </Typography>

                  {/* Mechanism Points - Updated for Semaglutide */}
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                    {[
                      {
                        icon: <Droplet size={24} color={colors.darkBlue} />,
                        title: "GLP-1 Activation",
                        description: "Mimics natural GLP-1 hormone to regulate blood sugar and appetite"
                      },
                      {
                        icon: <Heart size={24} color={colors.darkBlue} />,
                        title: "Cardiovascular Support",
                        description: "Provides cardiovascular benefits beyond weight loss"
                      },
                      {
                        icon: <ShieldCheck size={24} color={colors.darkBlue} />,
                        title: "Oral Bioavailability",
                        description: "Special formulation for effective oral absorption"
                      }
                    ].map((point, index) => (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  {/* Main Description - Updated for Semaglutide */}
                  <Box
                    sx={{
                      p: 4,
                      borderRadius: "20px",
                  ...
                  >
                    ...
                    >
                      Oral Semaglutide RDT activates GLP-1 receptors in the brain, pancreas, 
                      and gastrointestinal tract, reducing appetite, slowing stomach emptying, 
                      and improving insulin sensitivity for comprehensive weight management.
                    </Typography>
                  ...
                  {/* Usage Instructions - Updated for Semaglutide */}
                  <Box
                    sx={{
                      p: 3,
                      backgroundColor: colors.white,
...
>
  ...
  appropriate medical oversight.
      ...
      {/* Testimonials Section - Updated for Semaglutide */}
      <TestimonialCarousel />
        ...
        <Container sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            <Box sx={{ 
              ...
              >
                Take the first step with clinically-proven oral GLP-1 therapy. 
                Our convenient RDT format offers the benefits of Semaglutide without 
                injections. Start your personalized treatment plan today.
              </Typography>
              ...
              <Box sx={{ 
                ...
                >
                  ...
                  >
                    Or learn more about GLP-1 therapy
                  </Typography>
                </motion.div>
              </Box>

              {/* Features/Guarantees - Updated for Semaglutide */}
              <Grid container spacing={3} justifyContent="center" sx={{ mt: 4 }}>
                {[
                  { text: "Clinically Proven Results" },
                  { text: "Free Medical Consultation" },
                  { text: "Oral Convenience" },
...
// Testimonial Component - Updated for Semaglutide
  ...
  const testimonials = [
    {
      ...
      content: 'Oral Semaglutide changed everything for me. No more injections and I lost 25 pounds in 4 months. The convenience is unmatched!',
      result: 'Lost 25 lbs',
    ...
    },
    {
      ...
      content: 'Finally, a GLP-1 treatment I can take orally. My blood sugar is under control and I have more energy than ever before.',
      result: 'A1C: 5.8%',
    ...
    },
    {
      ...
      content: 'The oral RDT is so easy to use. I take it every morning and it helps control my appetite throughout the day. Down 30 pounds!',
      result: 'Weight: -30 lbs',
      ...
      <Container maxWidth="lg">
        ...
        >
          <Box textAlign="center" mb={{ xs: 6, md: 8 }}>
            ...
            >
              Real patients achieving significant weight loss with oral GLP-1 therapy
            </Typography>
          </Box>
...
export default OralSemaglutidePage;