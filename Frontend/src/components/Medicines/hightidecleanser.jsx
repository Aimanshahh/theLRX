        ...
        >
          ...
          >
            ...
            <Typography sx={{ mt: 1.5, fontSize: { xs: "16px", md: "18px" }, color: "#FFFFFF", lineHeight: 1.6, mb: 3 }}>
              Our <Box component="span" sx={{ color: "#FFFFFF", fontWeight: 600 }}>powerful yet gentle cleanser</Box> removes impurities without stripping your skin's natural moisture.
            </Typography>
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              ...
              >
                Refresh Your Skin Now
              </Button>
            </motion.div>

            <Typography sx={{ color: "#FFFFFF", mt: 3, fontSize: 14, opacity: 0.9 }}>
              <CheckCircle size={14} color="#FFFFFF" /> Suitable for all skin types
            </Typography>
          </motion.div>
          ...
          >
            <Box sx={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.25)" }}>
              <img src={creamImg} alt="High Tide Cleanser" style={{ width: "100%", display: "block" }} />
            </Box>
        ...
        <Container maxWidth="lg">
          ...
          >
            <Box sx={{ textAlign: "center", mb: { xs: 8, md: 12 } }}>
              ...
              >
                A transformative cleansing experience that purifies, balances, and revitalizes your skin
              </Typography>
            </Box>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Gently lifts away dirt, oil, and makeup without harsh scrubbing",
                color: "#00359E",
              },
              {
                step: 2,
                ...
                description: "Maintains skin's natural pH balance and protective barrier",
                color: "#003B9D",
              },
              {
                step: 3,
                ...
                description: "Soft micro-beads remove dead skin cells for smoother texture",
                color: "#00359E",
              },
              {
                step: 4,
                icon: TrendingUp,
                title: "Hydrated Finish",
                description: "Leaves skin feeling clean, refreshed, and perfectly hydrated",
                color: "#003B9D",
              },
            ].map((item, index) => (
              <motion.div
              ...
              <Grid container spacing={4} alignItems="flex-start">
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography sx={{ fontSize: "18px", color: "#747578", lineHeight: 1.6, mb: 4 }}>
                    Experience visible improvements with consistent use:
                  </Typography>

                  <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                    {[
                      { time: "Day 1-3", improvement: "Noticeably cleaner, fresher skin", icon: Waves, color: "#00359E" },
                      { time: "Day 4-7", improvement: "Reduced pore appearance", icon: Eye, color: "#003B9D" },
                      { time: "Day 8-11", improvement: "Improved skin texture", icon: Shield, color: "#00359E" },
                      { time: "Day 12-14", improvement: "Balanced, hydrated complexion", icon: Droplets, color: "#003B9D" },
                    ].map((milestone, idx) => (
        ...
        <Container maxWidth="lg">
            ...
            {[
              {
                Icon: Waves,
                title: "Deep Clean",
                text: "Removes 99% of impurities without stripping",
                color: "#00359E",
                index: 1
              },
              {
                Icon: Shield,
                title: "Balanced",
                text: "Maintains skin's natural pH level",
                color: "#003B9D",
                index: 2
              },
              {
                Icon: Droplets,
                title: "Hydrating",
                text: "Leaves skin moisturized, not tight",
                color: "#00359E",
                index: 3
              }
            ].map((benefit, index) => (
          ...
          >
            <Box sx={{ 
              ...
              {[
                { value: "96%", label: "Cleaner Skin" },
                { value: "No Stripping", label: "Gentle Formula" },
                { value: "3.5K+", label: "Daily Users" }
              ].map((stat, index) => (
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <Box sx={{ textAlign: "center", maxWidth: 800, mx: "auto" }}>
              <Typography sx={{ fontSize: { xs: "22px", md: "30px" }, fontWeight: 900, color: "#000000", mb: 1 }}>
                Ready for perfectly clean skin?
              </Typography>
              <Typography sx={{ color: "#747578", fontSize: 15, mb: 4 }}>
                Experience the difference with our gentle yet effective daily cleanser.
              </Typography>
...
export default HighTideCleanser;