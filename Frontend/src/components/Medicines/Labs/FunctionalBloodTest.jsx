    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            <AccessTimeIcon sx={{ fontSize: { xs: 20, sm: 24 }, color: 'white' }} />
            <Typography
              variant="h6"
              sx={{
                color: 'white',
          ...
          >
            Advanced diagnostic tools under construction
          </Typography>
          ...
          >
            ...
            >
              ...
              >
                <AccessTimeIcon sx={{ fontSize: 32, color: colors.darkBlue }} />
              </Box>
            </Box>
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              >
                This Functional Blood Test section is currently under development. We're working 
                hard to bring you advanced diagnostic tools and comprehensive analytical capabilities.
              </Typography>
            </Box>
            ...
            >
              ...
              >
                <ConstructionIcon sx={{ fontSize: 14, color: colors.darkBlue }} />
                <Typography
                  variant="caption"
                  sx={{
                    color: colors.darkBlue,
          ...
          >
            <Typography variant="body1" sx={{ color: colors.darkGrey, textAlign: 'center' }}>
              This section will be available in a future update. Thank you for your patience.
            </Typography>
          </Box>
        </Box>
      </Container>
