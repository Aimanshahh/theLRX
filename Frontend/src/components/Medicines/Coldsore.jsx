        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: { xs: "38px", md: "48px" }, fontWeight: 900, color: "#FFFFFF", lineHeight: 1.05, mb: 2 }}>
              Fast Cold Sore Relief,
              <br />
              Gentle Healing
            </Typography>

            <Typography sx={{ mt: 1.5, fontSize: { xs: "16px", md: "18px" }, color: "#FFFFFF", lineHeight: 1.6, mb: 3 }}>
              Our <Box component="span" sx={{ color: "#FFFFFF", fontWeight: 600 }}>advanced antiviral formula</Box> speeds healing, reduces pain, and helps prevent future outbreaks.
            </Typography>
            ...
            <Typography sx={{ color: "#FFFFFF", mt: 3, fontSize: 14, opacity: 0.9 }}>
              <CheckCircle size={14} color="#FFFFFF" /> Clinically proven formula
            </Typography>
          </motion.div>
          ...
          >
            <Box sx={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.25)" }}>
              <img src={creamImg} alt="Cold sore treatment" style={{ width: "100%", display: "block" }} />
            </Box>
        ...
        <Container maxWidth="lg">
          ...
          >
            <Box sx={{ textAlign: "center", mb: { xs: 8, md: 12 } }}>
              ...
              >
                Our four-step protocol accelerates healing while providing comfort and preventing recurrence
              </Typography>
            </Box>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Apply at first tingling sensation to minimize outbreak severity and duration",
                color: "#00359E",
              },
              {
                step: 2,
                ...
                description: "Antiviral action targets HSV-1 virus to stop replication and spread",
                color: "#003B9D",
              },
              {
                step: 3,
                ...
                description: "Reduces pain, itching, and inflammation for immediate comfort",
                color: "#00359E",
              },
              {
                step: 4,
                icon: TrendingUp,
                title: "Healing & Prevention",
                description: "Promotes rapid healing while helping prevent future outbreaks",
                color: "#003B9D",
              },
            ].map((item, index) => (
              <motion.div
              ...
              <Grid container spacing={4} alignItems="flex-start">
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography sx={{ fontSize: "18px", color: "#747578", lineHeight: 1.6, mb: 4 }}>
                    Clinical studies show our formula accelerates the healing process significantly:
                  </Typography>

                  <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                    {[
                      { time: "Day 1-2", improvement: "Reduced pain & tingling", icon: Thermometer, color: "#00359E" },
                      { time: "Day 3-4", improvement: "Less swelling & redness", icon: Eye, color: "#003B9D" },
                      { time: "Day 5-6", improvement: "Scabbing & healing begins", icon: Shield, color: "#00359E" },
                      { time: "Day 7+", improvement: "Complete healing achieved", icon: Award, color: "#003B9D" },
                    ].map((milestone, idx) => (
        ...
        <Container maxWidth="lg">
            ...
            {[
              {
                Icon: Clock,
                title: "Fast-Acting",
                text: "Starts working within hours of application",
                color: "#00359E",
                index: 1
              },
              {
                Icon: Shield,
                title: "Antiviral",
                text: "Targets HSV-1 virus at the source",
                color: "#003B9D",
                index: 2
              },
              {
                Icon: Thermometer,
                title: "Soothing",
                text: "Provides immediate pain & itch relief",
                color: "#00359E",
                index: 3
              }
            ].map((benefit, index) => (
          ...
          >
            <Box sx={{ 
              ...
              {[
                { value: "73%", label: "Faster Healing" },
                { value: "2 Hours", label: "Pain Relief" },
                { value: "3.1K+", label: "Satisfied Users" }
              ].map((stat, index) => (
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <Box sx={{ textAlign: "center", maxWidth: 800, mx: "auto" }}>
              <Typography sx={{ fontSize: { xs: "22px", md: "30px" }, fontWeight: 900, color: "#000000", mb: 1 }}>
                Tired of painful cold sores?
              </Typography>
              <Typography sx={{ color: "#747578", fontSize: 15, mb: 4 }}>
                Get fast, effective relief and prevent future outbreaks with our proven formula.
              </Typography>
