...
import viagraImg from "../../assets/medicines/Tirzepatide Vial.png"; // change path if needed
import { 
  Box, 
  Typography, 
  Button, 
...
const CarouselTestimonials = () => {
  const testimonials = [
    { name: "Robert Johnson", role: "Patient, 52", text: "Viagra gave me back my confidence and intimacy with my wife. Life-changing treatment." },
    { name: "Dr. Michael Chen", role: "Urologist", text: "Clinically proven efficacy with over 20 years of trusted medical use worldwide." },
    { name: "David Wilson", role: "Patient, 48", text: "Reliable and effective. The consistent results have improved my relationship significantly." },
    { name: "Sarah Thompson", role: "Partner", text: "Seeing my husband regain his confidence has brought us closer than ever." }
  ];
...
const Viagra = () => {
  ...
  // Color palette - adjusted for medical/trust theme
  const colors = {
    darkBlue: '#00359E',
    lightBlue: '#0066CC',
    medicalBlue: '#1A73E8',
          ...
          <Box
            sx={{
              ...
              background: `linear-gradient(135deg, 
                ...
                ${alpha(colors.medicalBlue, 0.25)} 100%
              )`,
              zIndex: 2
            }}
          />
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    ...
                    <Box
                      ...
                      sx={{
                        display: 'block',
                        background: `linear-gradient(135deg, ${colors.medicalBlue} 0%, ${colors.darkBlue} 100%)`,
                        backgroundClip: 'text',
                        WebkitBackgroundClip: 'text',
                        color: 'transparent',
                        mt: -1
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    The world's #1 prescribed erectile dysfunction treatment with over 20 years of proven efficacy.
                  </Typography>
                </motion.div>
              </Grid>

              {/* Icons Section - Medical Benefits */}
              <Grid item xs={12}>
                <motion.div variants={fadeInUp}>
                ...
                >
                  <Button
                    ...
                    sx={{
                      ...
                      fontSize: { xs: '0.95rem', md: '1.1rem' },
                      fontWeight: 700,
                      background: `linear-gradient(135deg, ${colors.medicalBlue}, ${colors.darkBlue})`,
                      borderRadius: '30px',
                      textTransform: 'uppercase',
                      letterSpacing: '0.5px',
                      ...
                      '&:hover': {
                        background: `linear-gradient(135deg, ${colors.darkBlue}, ${colors.medicalBlue})`,
      ...
      >
        ...
        <Box
          sx={{
            ...
            right: 0,
            bottom: 0,
            background: `radial-gradient(circle at 20% 80%, ${alpha(colors.medicalBlue, 0.03)} 0%, transparent 50%),
                        radial-gradient(circle at 80% 20%, ${alpha(colors.darkBlue, 0.02)} 0%, transparent 50%)`,
            zIndex: 0
          }}
        />
          ...
          >
            <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
              ...
              <motion.div variants={fadeInUp}>
                ...
                >
                  Backed by decades of research and millions of satisfied patients worldwide
                </Typography>
              </motion.div>
            </Box>
          </motion.div>
              ...
              {[
                {
                  ...
                  description: 'Enhances erectile function for better sexual performance and satisfaction.',
                  color: colors.medicalBlue,
                  delay: 0.1,
                  gradient: `linear-gradient(135deg, ${alpha(colors.medicalBlue, 0.1)}, ${alpha(colors.darkBlue, 0.1)})`
                },
                {
                  icon: <Clock size={28} />,
                  title: 'Fast Acting',
                  description: 'Works in as little as 30 minutes, with effects lasting up to 4 hours.',
                  color: colors.darkBlue,
                  delay: 0.2,
                  gradient: `linear-gradient(135deg, ${alpha(colors.darkBlue, 0.1)}, ${alpha(colors.medicalBlue, 0.1)})`
                },
                {
                  icon: <ShieldCheck size={28} />,
                  title: 'Well-Tolerated',
                  description: 'Over 20 years of safety data with established dosing guidelines.',
                  color: '#4CAF50',
                  delay: 0.3,
                  gradient: `linear-gradient(135deg, ${alpha('#4CAF50', 0.1)}, ${alpha(colors.medicalBlue, 0.1)})`
                },
                {
                  icon: <Users size={28} />,
                  title: 'Relationship Benefits',
                  description: 'Improves intimacy and relationship satisfaction for couples.',
                  color: colors.accentRed,
                  delay: 0.4,
                  gradient: `linear-gradient(135deg, ${alpha(colors.accentRed, 0.1)}, ${alpha(colors.medicalBlue, 0.1)})`
                }
              ].map((feature, index) => (
                    ...
                    <Card
                      sx={{
                        ...
                        '&:hover': {
                          ...
                          boxShadow: `0 12px 40px ${alpha(colors.medicalBlue, 0.15)}`,
                          '& .feature-icon': {
                        ...
                        '&::before': {
                          ...
                          right: 0,
                          height: '4px',
                          background: `linear-gradient(90deg, ${feature.color}, ${colors.medicalBlue})`,
                          opacity: 0.8
                        }
                      }}
                    >
                      <Box
                        sx={{
                          ...
                          borderRight: { md: `1px solid ${alpha(colors.medicalBlue, 0.1)}` }
                        }}
                      >
                        <Box
        ...
        <Box
          sx={{
            py: { xs: 12, md: 16 },
            background: `radial-gradient(circle at top, ${alpha(colors.medicalBlue, 0.12)}, transparent 60%),
                         linear-gradient(135deg, ${alpha(colors.medicalBlue, 0.04)}, ${alpha(colors.darkBlue, 0.08)})`,
            display: "flex",
            justifyContent: "center",
            alignItems: "center",
            position: "relative",
        ...
        >
          ...
          <Box
            sx={{
              ...
              height: 420,
              borderRadius: "50%",
              background: alpha(colors.medicalBlue, 0.18),
              filter: "blur(150px)",
              top: "12%",
              left: "50%",
              transform: "translateX(-50%)",
              ...
              <Card
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: `0 45px 130px ${alpha(colors.medicalBlue, 0.45)}`,
                  },
                }}
              >
                {/* Medicine Image */}
                ...
                <CardContent sx={{ textAlign: "center", py: 4 }}>
                  ...
                  >
                    Prescription-Strength ED Treatment
                  </Typography>
                </CardContent>
              </Card>
            </motion.div>
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    height: 4,
                    borderRadius: 999,
                    background: `linear-gradient(90deg, ${colors.medicalBlue}, ${colors.darkBlue})`,
                  }}
                />
                ...
                <Box
                  sx={{
                    ...
                    height: 280,
                    borderRadius: "50%",
                    background: alpha(colors.medicalBlue, 0.22),
                    filter: "blur(150px)",
                    top: -100,
                    right: -100,
                  }}
                ...
                >
                  Viagra works by relaxing blood vessels and increasing blood flow to specific areas of the body, 
                  helping men with erectile dysfunction achieve and maintain an erection when sexually aroused.
                </Typography>
                ...
                >
                  With over two decades of clinical use and extensive research, Viagra remains the most prescribed 
                  and trusted treatment for erectile dysfunction, helping millions of men worldwide regain confidence 
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  Scientifically Backed Mechanism
                </Typography>
              </Box>
            </motion.div>
              ...
              {[
                {
                  ...
                  text: "Relaxes blood vessels to improve circulation to specific areas.",
                },
                {
                  icon: <ActivitySquare size={22} />,
                  title: "Enhanced Response",
                  text: "Works with sexual stimulation for natural erectile response.",
                },
                {
                  icon: <Clock size={22} />,
                  title: "Timely Effect",
                  text: "Typically works within 30-60 minutes, lasting up to 4 hours.",
                },
                {
                  icon: <ShieldCheck size={22} />,
                  title: "Doctor Monitored",
                  text: "Requires prescription and proper medical supervision.",
                },
              ].map((item, i) => (
                    ...
                    <Box
                      sx={{
                        ...
                        "&:hover": {
                          ...
                          boxShadow: `0 14px 40px ${alpha(colors.medicalBlue, 0.2)}`,
                        },
                      }}
                    >
                      {/* Icon */}
                      <Box
                        sx={{
                          ...
                          alignItems: "center",
                          justifyContent: "center",
                          background: alpha(colors.medicalBlue, 0.08),
                          color: colors.medicalBlue,
                        }}
                      >
                        {item.icon}
        ...
        <Box sx={{ py: { xs: 12, md: 16 }, backgroundColor: alpha(colors.medicalBlue, 0.03) }}>
          <Container maxWidth="lg">
            {/* Section Header */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                Consult with a licensed healthcare provider to see if Viagra is right for you. 
                Regain confidence and improve your intimate relationships.
              </Typography>
              ...
              >
                *Viagra is a prescription medication. Results may vary. Only a healthcare provider 
                can determine if Viagra is appropriate for you based on your medical history and 
                current health status. Use only as directed.
              </Typography>
            </motion.div>
          </Container>
        </Box>
