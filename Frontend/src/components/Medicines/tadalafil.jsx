    ...
    <>
      ...
      <Box
        sx={{
          ...
          backgroundImage: `url(${tadalafilBanner})`,
          ...
          >
            ...
            >
              ...
              <Typography sx={{ color: "#E0E0E0", mb: 2 }}>
                Long-lasting performance. Reliable results.
              </Typography>

              <Typography sx={{ color: "#fff", mb: 3 }}>
                A clinically-proven solution for erectile dysfunction, providing 
                up to 36 hours of reliable performance with a single dose.
              </Typography>
            ...
            <Grid item xs={12} md={6} display="flex" flexDirection="column">
              ...
              >
                ...
                <Typography sx={{ fontSize: 16, color: palette.grey, mb: 4, lineHeight: 1.8 }}>
                  Tadalafil is a phosphodiesterase type 5 (PDE5) inhibitor that works by 
                  increasing blood flow to the penis, facilitating erections when sexually 
                  aroused. Its extended half-life provides up to 36 hours of effectiveness, 
                  offering greater spontaneity compared to other ED medications.
                </Typography>

                {/* Benefits List */}
                <Box sx={{ mb: 5 }}>
                  {[
                    "Provides up to 36 hours of effectiveness",
                    "Enhances sexual performance and confidence",
                    "Improves erectile function in 80% of men",
                    "Allows for greater sexual spontaneity",
        ...
        <Container>
          ...
          >
            <Box sx={{ 
              ...
              >
                Experience enhanced sexual performance through clinically-proven benefits
              </Typography>
            </Box>
          </motion.div>
            ...
            {[
              {
                icon: "Zap",
                title: "Long Duration",
                description: "Up to 36 hours of effectiveness",
                color: "#FF6B35",
              },
              {
                icon: "Heart",
                title: "Enhanced Performance",
                description: "Improved erectile function",
                color: "#E91E63",
              },
              {
                icon: "Dumbbell",
                title: "Reliable Results",
                description: "Consistent, predictable outcomes",
                color: "#00359E",
              },
              {
                icon: "Brain",
                title: "Greater Confidence",
                description: "Improved sexual spontaneity",
                color: "#673AB7",
              },
            ].map((benefit, index) => (
          ...
          >
            ...
            >
              {[
                { value: "36hr", label: "Duration of Effect" },
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  >
                    ...
                    <Box
                      component="img"
                      src={tadalafilProduct}
                      alt="Tadalafil Product"
                      sx={{
                        width: "100%",
                        height: "auto",
                        borderRadius: "12px",
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  <Box>
                    ...
                    <Box sx={{ mb: 4 }}>
                      {[
                        "Extended 36-hour duration of effect",
                        "Pharmaceutical-grade purity and consistency",
                        "Minimal food interaction for flexible dosing",
                    ...
                    <Box sx={{ mb: 5 }}>
                      ...
                      >
                        Our Tadalafil formulation is engineered for maximum effectiveness 
                        and patient convenience. Each tablet delivers consistent, reliable 
                        results with an extended duration that allows for greater sexual 
                        spontaneity.
                      </Typography>
                      ...
                      >
                        Manufactured in FDA-registered facilities and backed by extensive 
                        clinical research, our formula provides predictable performance 
                    ...
                    >
                      <Grid container spacing={2}>
                        {[
                          ...
                          { label: "Duration", value: "Up to 36hr" },
        ...
        <Container sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            <Box sx={{ 
              ...
              >
                Take the first step towards improved confidence, performance, and 
                satisfaction. Our medical team is ready to guide you through a 
                personalized Tadalafil treatment plan.
              </Typography>
