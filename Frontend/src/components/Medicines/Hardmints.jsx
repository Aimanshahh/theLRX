...
import medicineImg from "../../assets/medicines/Tirzepatide Vial.png"; // change path if needed
import { 
  Box, 
  Typography, 
  Button, 
...
const fallbackVideoUrl = 'https://assets.mixkit.co/videos/preview/mixkit-mint-green-circles-rotating-in-abstract-space-41527-large.mp4';

// Carousel Component defined separately
const CarouselTestimonials = () => {
  const testimonials = [
    { name: "John Doe", role: "Fitness Enthusiast", text: "These mints are amazing! I feel focused and energized all day long." },
    { name: "Jane Smith", role: "Health Coach", text: "Premium quality and great flavor. Truly a luxury experience." },
    { name: "Alex Johnson", role: "Professional Athlete", text: "Sustained energy without crashes. Best mint I've ever tried." },
    { name: "Sara Lee", role: "Wellness Expert", text: "Natural ingredients, effective results, and excellent taste." }
  ];
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                <motion.div variants={fadeInUp}>
                  ...
                  >
                    Premium performance mints with intense flavor and lasting freshness.
                  </Typography>
                </motion.div>
              </Grid>

              {/* Icons Section - Simple Icons */}
              <Grid item xs={12}>
                <motion.div variants={fadeInUp}>
                  <Grid container spacing={2} justifyContent="flex-start">
                    {[
                      ...
                      {
                        icon: <Sparkles size={isMobile ? 22 : 26} color={colors.white} />,
          ...
          >
            <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
              ...
              <motion.div variants={fadeInUp}>
                ...
                >
                  Experience the perfect blend of premium ingredients and advanced formulation for optimal results
                </Typography>
              </motion.div>
            </Box>
          </motion.div>
              ...
              {[
                {
                  ...
                  description: 'Made with 100% natural, premium ingredients. No artificial additives or preservatives.',
                  color: '#4CAF50',
                  delay: 0.1,
                  gradient: `linear-gradient(135deg, ${alpha(colors.darkBlue, 0.1)}, ${alpha('#4CAF50', 0.1)})`
                },
                {
                  icon: <BatteryCharging size={28} />,
                  title: 'Sustained Energy',
                  description: 'Get lasting energy without the crash. Perfect for workouts and long days.',
                  color: colors.darkBlue,
                  delay: 0.2,
                ...
                },
                {
                  ...
                  description: 'Enhance focus and concentration with our specially formulated blend.',
                  color: colors.lightBlue,
                  delay: 0.3,
                  gradient: `linear-gradient(135deg, ${alpha(colors.lightBlue, 0.1)}, ${alpha('#9C27B0', 0.1)})`
                },
                {
                  icon: <Heart size={28} />,
                  title: 'Heart Healthy',
                  description: 'Supports cardiovascular health and promotes better circulation.',
                  color: '#F44336',
                  delay: 0.4,
                  gradient: `linear-gradient(135deg, ${alpha('#F44336', 0.1)}, ${alpha(colors.darkBlue, 0.1)})`
                }
              ].map((feature, index) => (
          ...
          <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                ...
                <CardContent sx={{ textAlign: "center", py: 4 }}>
                  ...
                  >
                    Pharmaceutical-Grade Performance Mint
                  </Typography>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  Engineered for rapid oral absorption and controlled physiological performance,
                  this formulation delivers long-lasting freshness and clean, sustained activation
                  through precision-balanced bioactive compounds.
                </Typography>
                ...
                >
                  Designed for individuals who require consistency without crashes, sugar overload,
                  or artificial compromise. Every dose is calibrated to support clarity, balance,
                  and metabolic efficiency in a refined, medical-grade delivery format.
                </Typography>
              </Box>
            </motion.div>
          </Container>
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: "center", mb: 6 }}>
                ...
                >
                  Designed for Precision Delivery
                </Typography>
              </Box>
            </motion.div>
              ...
              {[
                {
                  ...
                  title: "Fast Dissolve",
                  text: "Quick oral absorption for immediate activation.",
                },
                {
                  icon: <Brain size={22} />,
                  title: "Targeted Action",
                  text: "Compounds engage neurological pathways accurately.",
                },
                {
                  icon: <Activity size={22} />,
                  title: "Sustained Effect",
                  text: "Controlled release prevents performance crashes.",
                },
                {
                  icon: <ShieldCheck size={22} />,
                  title: "Balanced & Safe",
                  text: "Maintains metabolic and cardiac stability.",
                },
              ].map((item, i) => (
...
>
  ...
  <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
    ...
    >
      ...
      >
        Experience Premium Hard Mints Today
      </Typography>
      ...
      >
        Unlock sustained freshness, mental clarity, and balanced energy with every mint. Join thousands enjoying premium performance in every dose.
      </Typography>
