          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  A compounded formula blending gentle circulatory enhancement with balanced neuro-hormonal support to elevate desire, sensitivity, and emotional connection naturally. Now with extended 12-tablet supply.
                </Typography>
        ...
        <Container maxWidth="lg">
            ...
            <Grid item xs={12} md={7}>
              <Box sx={{ 
                ...
                <Typography sx={{ 
                  ...
                  Lust is specifically compounded for women's intimate wellness. This dual-ingredient formula works synergistically to provide gentle circulatory enhancement and balanced neuro-hormonal support for a natural elevation of desire and connection, now with extended 12-tablet supply.
                </Typography>
                ...
                <Box sx={{ flex: 1 }}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Box sx={{ 
                        ...
                        {[
                          ...
                          "12-tablet extended supply for continued wellness"
                        ].map((point, index) => (
                          <Box key={index} sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                            <Box
                              sx={{
                  ...
                  <Box sx={{ 
                    ...
                    <Typography sx={{ 
                      ...
                      For a more complete women's intimate wellness experience: Stack Lust with PT-141 for amplified arousal, NAD+ Injectable for deeper vitality, and GHK-Cu for comprehensive support. Perfect with our 12-tablet extended supply.
                    </Typography>
                  </Box>
                </Box>
              </Box>
              ...
              >
                ...
                <Box sx={{ 
                  ...
                  <Typography sx={{ 
                    ...
                    Specifically compounded for extended natural elevation of women's intimate desire and connection
                  </Typography>
                </Box>
              </Box>
            </Grid>
          ...
          <Box sx={{ 
            ...
            <Typography sx={{ 
              ...
              Lust is designed to stack optimally with PT-141 (for amplified arousal), NAD+ Injectable (for deeper vitality), and GHK-Cu (for comprehensive intimate wellness). This 12-tablet combination creates a more complete women's intimate wellness experience with extended supply.
            </Typography>
          </Box>
        </Container>
      </Box>
        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ textAlign: "center", mb: { xs: 6, md: 8 } }}>
            ...
            >
              ...
              >
                Compounded intimate wellness tablets with extended 12-tablet supply to naturally elevate desire, sensitivity, and emotional connection
              </Typography>
            </motion.div>
          </Box>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ mb: 4 }}>
                  ...
                  >
                    Compounded Lust Tablets - 12 Pack
                  </Typography>
                  <Typography
                    sx={{
                      color: "#747578",
                  ...
                  >
                    Lust blends gentle circulatory enhancement with balanced neuro-hormonal support to elevate desire, sensitivity, and emotional connection in a beautifully natural way. Now with extended 12-tablet supply.
                  </Typography>
                </Box>
                ...
                >
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                    {[
                      ...
                      "12-tablet extended supply for continued wellness journey"
                    ].map((benefit, index) => (
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 8 }}>
            ...
            >
              ...
              >
                Lust works to create a more natural and complete intimate wellness experience with extended 12-tablet supply
              </Typography>
            </motion.div>
          </Box>
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                Elevate desire, sensitivity, and emotional connection with our compounded Lust-12 Tablets. Beautifully designed for a more natural and complete women's intimate wellness experience with extended supply.
              </Typography>
