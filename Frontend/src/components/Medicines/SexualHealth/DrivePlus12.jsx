        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ...
              >
                <Chip
                  label="PREMIUM ENERGY FORMULA - 12 TABLETS"
                  icon={<Zap size={16} />}
                  sx={{
                ...
                >
                  Drive Plus 12 Tablets — premium energy formula designed to enhance 
            ...
            <Grid item xs={12} md={7}>
              <Box sx={{ 
                ...
                <Typography sx={{ 
                  ...
                  Drive Plus 12 Tablets are formulated based on extensive research in 
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                Experience sustained energy and enhanced focus with Drive Plus 12 Tablets. 
