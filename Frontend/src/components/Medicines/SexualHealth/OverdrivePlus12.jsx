        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ...
              >
                <Chip
                  label="ENERGY & PERFORMANCE FORMULA - 12 TABLETS"
                  icon={<Zap size={16} />}
                  sx={{
                ...
                >
                  OverDrive Plus 12 Tablets — premium energy and performance formula designed 
            ...
            <Grid item xs={12} md={7}>
              <Box sx={{ 
                ...
                <Typography sx={{ 
                  ...
                  OverDrive Plus 12 Tablets are formulated based on extensive research in sports 
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              >
                Experience sustained energy and enhanced performance with OverDrive Plus 12 Tablets. 
