...
const CJC1295IpamorelinPage = () => {
 
   const rimioUrl = "https://try.thelrx.com/intake/cj-r201jp";
        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: { xs: "38px", md: "48px" }, fontWeight: 900, color: palette.white, lineHeight: 1.05, mb: 2 }}>
              ...
              <br />
              <Box component="span" sx={{ color: palette.white, fontSize: { xs: "42px", md: "52px" } }}>$199.00</Box>
            </Typography>
          ...
          >
            <Box sx={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.25)" }}>
              <img src={cjcIpamImage} alt="CJC-1295 / Ipamorelin Blend" style={{ width: "100%", height: "auto", display: "block" }} />
            </Box>
...
export default CJC1295IpamorelinPage;