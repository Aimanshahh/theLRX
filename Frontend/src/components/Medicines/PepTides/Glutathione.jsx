...
const Glutathione = () => {
  ...
  // Updated product data for Glutathione
  const productInfo = {
    name: "Glutathione Injection",
    description: "Glutathione (Emerald) is a potent antioxidant supplied as a sterile injectable solution. Formulated for professional intramuscular or intravenous administration.",
    detailedDescription: "Glutathione is a pharmaceutical-grade reduced L-glutathione manufactured under strict quality standards. Each vial contains a high-purity formulation prepared for injection use.",
    rating: "4.8/5.0",
    ...
    benefits: [
      "High-purity reduced glutathione",
    ...
    kitIncludes: [
      "Glutathione (Reduced) sterile injection solution",
      ...
      "Formulated for IM/IV administration",
      "Professional-grade pharmaceutical preparation"
    ],
    specifications: [
      { label: "Active Ingredient", value: "Reduced L-Glutathione" },
      { label: "Form", value: "Sterile Injection Solution" },
      { label: "Purity", value: "99%+" },
      { label: "Administration", value: "Intramuscular / Intravenous" }
    ],
    ctaText: "Order Glutathione - $97.00",
    disclaimer: "Glutathione is intended for injection under medical supervision. Prescription required. Administered by healthcare professionals only. Individual results may vary. Consult with a healthcare provider before use."
  };
  ...
  const stats = [
    { value: "Antioxidant", label: "Support" },
        ...
        <Box sx={{ width: "100%", maxWidth: "1200px", display: "flex", flexDirection: { xs: "column", md: "row" }, alignItems: "center", justifyContent: "space-between", position: "relative", zIndex: 2, gap: { xs: 6, md: 8 } }}>
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} style={{ maxWidth: "550px" }}>
            ...
            <Typography sx={{ mt: 1.5, fontSize: { xs: "16px", md: "18px" }, color: palette.white, lineHeight: 1.6, mb: 3 }}>
              Our <Box component="span" sx={{ color: palette.white, fontWeight: 600 }}>pharmaceutical-grade Glutathione (Emerald)</Box> is a sterile injection solution formulated for professional administration.
            </Typography>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} style={{ position: "relative", maxWidth: "480px", width: "100%" }}>
            <Box sx={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.25)" }}>
              <img src={glutathioneImage} alt={productInfo.name} style={{ width: "100%", height: "auto", display: "block" }} />
            </Box>
            ...
            <Grid item xs={12} md={6} display="flex" justifyContent={{ md: "flex-end", xs: "center" }}>
              <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} style={{ width: "100%", height: "100%" }}>
                <Box sx={{ position: "relative", width: "100%", height: "100%", borderRadius: "24px", overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}>
                  <video src={glutathioneScienceVideo} autoPlay muted loop playsInline style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </Box>
              </motion.div>
            </Grid>
          </Grid>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <Box sx={{ textAlign: "center", mb: { xs: 5, md: 7 } }}>
              ...
              <Typography variant="h2" sx={{ fontWeight: 800, fontSize: { xs: "28px", md: "36px" }, mb: 2, color: palette.black, lineHeight: 1.2 }}>
                Professional-Grade
                <Box component="span" sx={{ color: palette.darkBlue }}> Glutathione</Box>
              </Typography>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <Grid item xs={12} md={6}>
                <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                  <Box sx={{ position: "relative", borderRadius: "20px", overflow: "hidden", boxShadow: "0 15px 40px rgba(0, 53, 158, 0.1)", border: `1px solid ${palette.darkBlue}15`, maxWidth: "500px", mx: { xs: "auto", md: "0" }, ml: { md: "auto" }, mr: { md: "0" }, backgroundColor: palette.white, p: 2 }}>
                    <Box component="img" src={glutathioneProductImage} alt={`${productInfo.name} Vial`} sx={{ width: "100%", height: "auto", borderRadius: "12px", display: "block" }} />
            ...
            <Box sx={{ mt: { xs: 6, md: 8 } }}>
              <Typography sx={{ fontSize: "15px", color: palette.darkGrey, lineHeight: 1.7, mb: 3, maxWidth: "800px", mx: "auto", textAlign: "center" }}>
                Our Glutathione is supplied as a sterile injection solution manufactured under strict pharmaceutical standards.
              </Typography>
