        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: { xs: "38px", md: "48px" }, fontWeight: 900, color: palette.white, lineHeight: 1.05, mb: 2 }}>
              GHK-Cu 50mg
              <br />
              <Box component="span" sx={{ color: palette.white, fontSize: { xs: "42px", md: "52px" } }}>$179.00</Box>
            </Typography>
          ...
          >
            <Box sx={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.25)" }}>
              <img src={ghkCuImage} alt="GHK-Cu 50mg" style={{ width: "100%", height: "auto", display: "block" }} />
            </Box>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {benefit.icon === "Shield" && <Shield size={24} color={benefit.color} strokeWidth={2} />}
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  >
                    <Box
                      component="img"
                      src={ghkCuProductImage}
                      alt="GHK-Cu 50mg Powder"
                      sx={{
                        width: "100%",
                        height: "auto",
                        borderRadius: "12px",
