...
import bannerVideo from "../../assets/Videos/fixyourrecovery.mp4";

// PRODUCT IMAGES
import wegovyPill from "../../assets/Herocardspages/img1.jpeg";
import zepboundVial from "../../assets/Herocardspages/img18.jpeg";


export default function Fixyourrecovery() {
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              >
              *These statements have not been evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure, or prevent any disease. Individual results may vary. Consult with a licensed healthcare professional before use.
              </Typography>
            </Box>
          </Box>
        </Box>
