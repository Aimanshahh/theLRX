...
import { TrendingDown, Dumbbell , Sticker, ArrowRight } from "lucide-react";
import { useNavigate } from "react-router-dom"; // Added for navigation
import bannerVideo from "../../assets/Videos/buildmuscles.mp4";

// PRODUCT IMAGES
import wegovyPill from "../../assets/Herocardspages/img15.jpeg";
import zepboundVial from "../../assets/Herocardspages/img16.jpeg";
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              >
              *These statements have not been evaluated by the Food and Drug Administration. Individual results may vary. Consult with a healthcare professional before starting any muscle-building program, exercise routine, or supplementation plan.
              </Typography>
            </Box>
          </Box>
        </Box>
