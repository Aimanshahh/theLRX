    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            <HealthAndSafetyIcon sx={{ fontSize: { xs: 20, sm: 24 }, color: 'white' }} />
            <Typography
              variant="h6"
              sx={{
                color: 'white',
          ...
          >
            Resources and opportunities for healthcare professionals
          </Typography>
          ...
          >
            ...
            >
              ...
              >
                <MedicalServicesIcon sx={{ fontSize: 32, color: colors.darkBlue }} />
              </Box>
            </Box>
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              >
                We're developing a dedicated space for healthcare professionals. Soon you'll find 
                clinical resources, research collaborations, and partnership opportunities tailored to your expertise.
              </Typography>
            </Box>
            ...
            >
              ...
              >
                <MedicalServicesIcon sx={{ fontSize: 14, color: colors.darkBlue }} />
                <Typography
                  variant="caption"
                  sx={{
                    color: colors.darkBlue,
          ...
          >
            <Typography variant="body1" sx={{ color: colors.darkGrey, textAlign: 'center' }}>
              Interested in partnering with us? Reach out at <strong>support@lrx.com</strong>.
            </Typography>
          </Box>
        </Box>
      </Container>
