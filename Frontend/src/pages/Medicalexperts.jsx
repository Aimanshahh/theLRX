// Updated MedicalExperts.jsx - REMOVED Medical Advisory and Medical Executives sections
...
export default function MedicalExperts() {
  ...
  const navLinks = [
    ...
    { label: "Detailed Labs", path: "/DetailedLab" },
  ];
    ...
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <Typography sx={{ 
          ...
          <span style={{ color: "#00359E" }}> LiquidRX</span>
          ...
          <Box sx={{ 
            ...
            >
              ...
              <Typography sx={{ 
                ...
                * Based on consultation IDs created within the LiquidRX platform
              </Typography>
            </Box>
          </Box>
