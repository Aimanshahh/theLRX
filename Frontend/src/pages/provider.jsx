    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            <StorefrontIcon sx={{ fontSize: { xs: 20, sm: 24 }, color: 'white' }} />
            <Typography
              variant="h6"
              sx={{
                color: 'white',
          ...
          >
            Partner with us to expand your practice's capabilities
          </Typography>
          ...
          >
            ...
            >
              ...
              >
                <BusinessCenterIcon sx={{ fontSize: 32, color: colors.darkBlue }} />
              </Box>
            </Box>
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              >
                We're building a robust provider network to connect patients with trusted healthcare partners. 
                Soon you'll be able to join our platform and offer LiquidRX solutions to your patients.
              </Typography>
            </Box>
            ...
            >
              ...
              >
                <BusinessCenterIcon sx={{ fontSize: 14, color: colors.darkBlue }} />
                <Typography
                  variant="caption"
                  sx={{
                    color: colors.darkBlue,
          ...
          >
            <Typography variant="body1" sx={{ color: colors.darkGrey, textAlign: 'center' }}>
              Interested in becoming a provider? Contact us at <strong>support@lrx.com</strong>.
            </Typography>
          </Box>
        </Box>
      </Container>
