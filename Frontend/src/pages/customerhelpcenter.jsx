    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            <ContactSupportIcon sx={{ fontSize: { xs: 20, sm: 24 }, color: 'white' }} />
            <Typography
              variant="h6"
              sx={{
                color: 'white',
          ...
          >
            Support resources and FAQs coming soon
          </Typography>
          ...
          >
            ...
            >
              ...
              >
                <HelpOutlineIcon sx={{ fontSize: 32, color: colors.darkBlue }} />
              </Box>
            </Box>
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              >
                We're building a comprehensive help center with FAQs, guides, and support resources 
                to assist you with your health journey. Check back soon for helpful information.
              </Typography>
            </Box>
            ...
            >
              ...
              >
                <SupportAgentIcon sx={{ fontSize: 14, color: colors.darkBlue }} />
                <Typography
                  variant="caption"
                  sx={{
                    color: colors.darkBlue,
          ...
          >
            <Typography variant="body1" sx={{ color: colors.darkGrey, textAlign: 'center' }}>
              In the meantime, you can reach us at <strong>support@liquidrx.com</strong> or call <strong>(866) 669 9191</strong>.
            </Typography>
          </Box>
        </Box>
      </Container>
